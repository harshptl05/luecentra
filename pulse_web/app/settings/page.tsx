      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <p className="text-gray-600 mb-6">
            Experience how Pulse Glass works with unlimited responses.
          </p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-green-700 text-sm">
              {isFirebaseMode 
                ? 'Enjoy all Pulse Glass features for free in Firebase hosting mode. Pro and Enterprise plans will be released soon with additional premium features.'
                : 'Enjoy all Pulse Glass features for free in local mode. You can use personal API keys or continue using the free system.'
              }
            </p>
          </div>
        </div>
               ...
               <div className="bg-white border border-red-300 rounded-lg p-6">
                 ...
                 <p className="text-sm text-gray-600 mb-4">
                   {isFirebaseMode 
                     ...
                     : 'Permanently remove your personal account and all content from the Pulse Glass platform. This action cannot be undone, so please proceed carefully.'
                   }
                 </p>
                 <div className="mt-4 pt-4 border-t border-gray-200 flex justify-end">
                    <button
