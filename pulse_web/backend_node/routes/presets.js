...
router.post('/:id/activate', async (req, res) => {
    try {
        await ipcRequest(req, 'set-active-preset', req.params.id);
        res.json({ message: 'Preset activated successfully' });
    } catch (error) {
        console.error('Failed to activate preset via IPC:', error);
