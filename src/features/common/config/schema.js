const LATEST_SCHEMA = {
    ...
    prompt_presets: {
        columns: [
            ...
            { name: 'is_active', type: 'INTEGER DEFAULT 0' }, // Only one active preset per user
            { name: 'created_at', type: 'INTEGER' },
            { name: 'sync_state', type: 'TEXT DEFAULT \'clean\'' }
        ]
    },
    ...
    meeting_contexts: {
        columns: [
            ...
            { name: 'file_paths', type: 'TEXT' }, // JSON array of file paths
            { name: 'is_active', type: 'INTEGER DEFAULT 0' }, // Only one active context at a time
            { name: 'created_at', type: 'INTEGER' },
            { name: 'updated_at', type: 'INTEGER' },
            { name: 'sync_state', type: 'TEXT DEFAULT \'clean\'' }
        ]
