...
class ShortcutsService {
    ...
    getDefaultKeybinds() {
        ...
        return {
            ...
            triggerMeetingCoach: isMac ? 'Cmd+Shift+A' : 'Ctrl+Shift+A',
        };
    }
        ...
        for (const action in keybinds) {
            ...
            switch(action) {
                ...
                case 'nextResponse':
                    ...
                    break;
                case 'triggerMeetingCoach':
                    callback = async () => {
                        try {
                            const result = await listenService.triggerMeetingCoachAnswer();
                            if (result.success) {
                                console.log('[Shortcuts] Meeting coach answer triggered');
                            } else {
                                console.warn('[Shortcuts] Meeting coach trigger failed:', result.error);
                            }
                        } catch (error) {
                            console.error('[Shortcuts] Error triggering meeting coach:', error);
                        }
                    };
                    break;
            }
