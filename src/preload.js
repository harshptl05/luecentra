...
contextBridge.exposeInMainWorld('api', {
  ...
  common: {
    ...
    licensing: {
      getDeviceId: () => ipcRenderer.invoke('licensing:getDeviceId'),
      ensureActivated: () => ipcRenderer.invoke('licensing:ensureActivated'),
      loginWithCredentials: (email, password) => ipcRenderer.invoke('licensing:loginWithCredentials', { email, password }),
      loginWithTokens: (accessToken, refreshToken) => ipcRenderer.invoke('licensing:loginWithTokens', { accessToken, refreshToken }),
      logout: () => ipcRenderer.invoke('licensing:logout'),
      isLicensed: () => ipcRenderer.invoke('licensing:isLicensed'),
      getAccessToken: () => ipcRenderer.invoke('licensing:getAccessToken'),
    },
  },
  ...
  // src/ui/listen/meetingCoach/MeetingCoachView.js
  meetingCoach: {
    // Listeners
    onAnswer: (callback) => ipcRenderer.on('meeting-coach:answer', callback),
    removeOnAnswer: (callback) => ipcRenderer.removeListener('meeting-coach:answer', callback),
    onStatus: (callback) => ipcRenderer.on('meeting-coach:status', callback),
    removeOnStatus: (callback) => ipcRenderer.removeListener('meeting-coach:status', callback),
    
    // Context Management
    getAllContexts: () => ipcRenderer.invoke('meeting-coach:get-all-contexts'),
    createContext: (data) => ipcRenderer.invoke('meeting-coach:create-context', data),
    updateContext: (id, data) => ipcRenderer.invoke('meeting-coach:update-context', { id, ...data }),
    setActiveContext: (contextId) => ipcRenderer.invoke('meeting-coach:set-active-context', contextId),
    deleteContext: (contextId) => ipcRenderer.invoke('meeting-coach:delete-context', contextId),
    selectFiles: () => ipcRenderer.invoke('meeting-coach:select-files'),
    verifyPreset: () => ipcRenderer.invoke('meeting-coach:verify-preset'),
  },
  ...
  settingsView: {
    ...
    validateKey: (data) => ipcRenderer.invoke('model:validate-key', data),
    saveApiKey: (key, provider) => ipcRenderer.invoke('model:set-api-key', { provider: provider || 'openai', key }),
